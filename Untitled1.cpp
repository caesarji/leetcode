...
void solve(){
    ...
    rep(i , 0 , 5){
      ...
      if( (t1[i]=='1'|| t1[i]=='?') && (g1+1 > g2+5-i)       ) {ans=2*i+1; break;}
      if( (t1[i]=='1'|| t1[i]=='?') && (g1+5-i < g2)       ) {ans=2*i+1; break;}
      if( (t1[i]=='0') && (g1 > g2+5-i)      ) {ans=2*i+1; break;}
      if( (t1[i]=='0') && (g1 + 4-i , g2)      ) {ans=2*i+1; break;}

    if(t1[i]=='1' || t1[i]=='?')g1++;

    if(t2[i]=='1' && (g2+1 + 4-i<g1) ) {ans=2*i + 2;  break; }
    if(t2[i]=='1' && (g2+1>g1 + 4-i) ) {ans=2*i + 2;  break; }
    if(t2[i]!='1' && (g2 + 4-i<g1) ) {ans=2*i + 2;  break; }
    if(t2[i]!='1' && (g2>g1+4-i) ) {ans=2*i + 2;  break; }
